...
<nav class="navbar navbar-expand-lg fixed-top trans-navigation">
        <div class="container">
            <a class="navbar-brand" href="index.jsp">
                <img src="../../../theme/promodise/images/logo.png" alt="" class="img-fluid b-logo">
            </a>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-4">
                    <img src="../../../theme/promodise/images/about/about-4.jpg" alt="" class="img-fluid w-100">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="row">
            <div class="col-lg-6 ">
                <div class="media img-block mb-3 mb-lg-0">
                    <img src="../../../theme/promodise/images/about/h-1.jpg" alt="" class="img-fluid rounded mr-3">
            ...
            <div class="col-lg-6">
                <div class="media img-block">
                    <img src="../../../theme/promodise/images/about/h-2.jpg" alt="" class="img-fluid rounded mr-3">
...
<section class="section-padding bg-gray" >
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6">
                <img src="../../../theme/promodise/images/team/team-1.jpg" alt="" class="img-fluid rounded w-100">
            ...
            <div class="col-lg-3 col-md-6">
                <img src="../../../theme/promodise/images/team/team-2.jpg" alt="" class="img-fluid rounded w-100">
            ...
            <div class="col-lg-3 col-md-6">
                <img src="../../../theme/promodise/images/team/team-3.jpg" alt="" class="img-fluid rounded w-100">
            ...
            <div class="col-lg-3 col-md-6">
                <img src="../../../theme/promodise/images/team/team-4.jpg" alt="" class="img-fluid rounded w-100">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-3 col-sm-6 col-md-3 text-center">
                <img src="../../../theme/promodise/images/clients/client01.png" alt="partner" class="img-fluid">
            </div>
            <div class="col-lg-3 col-sm-6 col-md-3 text-center">
                <img src="../../../theme/promodise/images/clients/client06.png" alt="partner" class="img-fluid">
            </div>
            <div class="col-lg-3 col-sm-6 col-md-3 text-center">
                <img src="../../../theme/promodise/images/clients/client04.png" alt="partner" class="img-fluid">
            </div>
            <div class="col-lg-3 col-sm-6 col-md-3 text-center">
                <img src="../../../theme/promodise/images/clients/client05.png" alt="partner" class="img-fluid">
            </div>
        </div>
    </div>
</section>
...
<!--  FOOTER AREA END  -->
    ...
    <!-- Main jQuery -->
    <script src="../../../theme/promodise/plugins/jquery/jquery.min.js"></script>
    <!-- Bootstrap 4.3.1 -->
    <script src="../../../theme/promodise/plugins/bootstrap/js/popper.min.js"></script>
    <script src="../../../theme/promodise/plugins/bootstrap/js/bootstrap.min.js"></script>
   <!-- Woow animtaion -->
    <script src="../../../theme/promodise/plugins/counterup/wow.min.js"></script>
    <script src="../../../theme/promodise/plugins/counterup/jquery.easing.1.3.js"></script>
     <!-- Counterup -->
    <script src="../../../theme/promodise/plugins/counterup/jquery.waypoints.js"></script>
    <script src="../../../theme/promodise/plugins/counterup/jquery.counterup.min.js"></script>

    <!-- Google Map -->
    <script src="../../../theme/promodise/plugins/google-map/gmap3.min.js"></script>
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAkeLMlsiwzp6b3Gnaxd86lvakimwGA6UA&callback=initMap"></script>   
    <!-- Contact Form -->
    <script src="plugins/jquery/contact.js"></script>
    <script src="../../../theme/promodise/js/custom.js"></script>
