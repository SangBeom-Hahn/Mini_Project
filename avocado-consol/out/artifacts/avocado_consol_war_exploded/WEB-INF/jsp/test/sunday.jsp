...
<main>
    ...
    <div class="album py-5 bg-light">
        <div class="container">
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3 rounded-3" id="cards" ></div>
        </div>
    </div>
    ...
    <nav aria-label="Page navigation example">
        <ul class="pagination">
            ...
            <li class="page-item"><a class="page-link" onclick="paging(1)">1</a></li>
            <li class="page-item"><a class="page-link" onclick="paging(2)">2</a></li>
            <li class="page-item"><a class="page-link" onclick="paging(3)">3</a></li>
            <li class="page-item">
