...
<%
String bbs = (String) request.getAttribute("getBBS");
%>
<!doctype html>
<html lang="en">
<body>
              ...
              <div class="single-blog-item">
                ...
                <div class="blog-item-content bg-white p-5">
                  <div class="blog-item-meta bg-gray py-1 px-2">
                    <span class="text-muted text-capitalize mr-3" id="writer"><i class="ti-pencil-alt mr-2"></i></span>
                    <span class="text-black text-capitalize mr-3" id="date"><i class="ti-time mr-1"></i></span>
                  </div>

                  <h2 class="mt-3 mb-4" id="title"></h2>
                  <p class="lead mb-4" id="content"></p>
...
<script>
  ...
  function makeContent() {
    let content = $('#content');
    let text = bbs.content;
    content.append(text);
  }

  function makeWriter() {
    let writer = $('#writer');
    let text = bbs.writer_name;
    writer.append(text);
  }
